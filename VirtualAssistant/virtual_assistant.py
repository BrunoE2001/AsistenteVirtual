...
# obtenemos todas las voces y utilizamos la primera de ellas
voices = engine.getProperty('voices')
engine.setProperty('voice', voices[0].id)

# editamos la configuraccion por defecto
...
while True:
    ...
    if status:
        ...
        elif 'puedes descansar' in rec:
            speak("Gracias señor, llameme de nuevo si me necesita...")
            break
